...
export const MuseIcon: Icon = ({ className, ...props }) => (
  ...
  >
    <path d="M6.657 5.6C4.426 5.6 2.5 7.42 2.5 9.94c0 3.127 2.214 6.275 4.887 8.583 1.34.114 2.68-.426 3.613-1.46l1-1.12 1 1.12c.933 1.034 2.273 1.574 3.613 1.46 2.673-2.308 4.887-5.456 4.887-8.583 0-2.52-1.926-4.34-4.157-4.34-1.996 0-3.666 1.332-4.484 3.11-.274.597-.563 1.203-.859 1.81-.296-.607-.585-1.213-.859-1.81C10.323 6.932 8.653 5.6 6.657 5.6Zm0 2.24c1.11 0 2.11.83 2.66 1.95.42.85.83 1.76 1.25 2.68l.433.95c.29.63.79 1.04 1.43 1.04.64 0 1.14-.41 1.43-1.04l.433-.95c.42-.92.83-1.83 1.25-2.68.55-1.12 1.55-1.95 2.66-1.95 1.17 0 2.16.94 2.16 2.1 0 2.24-1.63 4.84-3.79 6.84-.71-.05-1.39-.37-1.86-.9l-1.82-2.04a2.24 2.24 0 0 0-3.37 0l-1.82 2.04c-.47.53-1.15.85-1.86.9-2.16-2-3.79-4.6-3.79-6.84 0-1.16.99-2.1 2.16-2.1Z" />
  </svg>
);
